...
public class TagService {
    ...
    public List<TaggedUserDto> tagList(Long post_id){

        List<TaggedUserDto> taggedUserDtoList = new ArrayList<>();
        ...
        for(Long userId : taggedUserIdList){
            ...
            TaggedUserDto taggedUserDto = new TaggedUserDto(user);
            taggedUserDtoList.add(taggedUserDto);
        }
